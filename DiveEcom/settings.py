"""
Django settings for DiveEcom project.
...
LOGIN_REDIRECT_URL = '/'
ACCOUNT_SIGNUP_FORM_CLASS = 'useraccount.forms.SignupForm'
...
WSGI_APPLICATION = 'DiveEcom.wsgi.application'
